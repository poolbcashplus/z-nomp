...
function SetupForPool(logger, poolOptions, setupFinished){
    ...
    // If not provided - you support the development of bcp-nomp
    var getProperAddress = function(address){

        if (address.length < 25 || address.length > 34) {
            return (poolOptions.invalidAddress || (poolOptions.testnet === true ? "n1nKYxXxND5ejxCeA38LQATDuCqnCG1E1y" : "CMWnXDvbUsXUhsDJg89RbKWqHbVXyFzT3G"));
        }
        ...
        if (poolOptions.testnet === false && address[0] !== 'C' && address[0] !== 'A') {
            return (poolOptions.invalidAddress || "CMWnXDvbUsXUhsDJg89RbKWqHbVXyFzT3G");
        }
